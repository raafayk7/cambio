...
| [0008](0008-branching-strategy.md)                              | Branch hierarchy main → development → release-vN → task (amended: harness carve-out, see 0028; release ceremony + docs-only flip commit, see 0044) | accepted | 2026-08-31 | —      |
...
| [0044](0044-release-pipeline-snapshot-adr-flip-tag-rollover.md) | /release pipeline: snapshot main, accept ADRs on the release branch, deploy by PR merge, tag, roll over (amends 0008)                              | proposed | 2026-09-08 | —      |
