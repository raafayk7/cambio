...
| 8. The room screen's compact table (`viewerSeat="internal"`) is byte-identical to today; zero diff to `room-screen.tsx` or the default `TableSurface` path.                  | No new test — verified by the diff itself; existing room-screen test suite re-run unmodified as a regression guard                                                                                                                                                                                                                                                                                                                                                                                                              | room-screen.tsx and the TableSurface internal-path branches are absent from the final changeset                                                                                                                                                                  |
