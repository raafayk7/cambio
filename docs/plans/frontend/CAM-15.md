...
| F3.8   | non-vitest (grep + emulated render, M4)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | motion classes reference only `ease.snap`/`duration-snap`/`duration-track` (+ the two spec-carried animations); reduced-motion emulation shows the spinner swap (card-wobble → pulse-soft) and `motion-reduce` variants present             |
...
| F5.1   | non-vitest (gallery review, M2–M4 renders)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 26 components × every class-floor state mounted and labelled; motion states live/looping; reduced-motion verified by emulation                                                                                                              |
